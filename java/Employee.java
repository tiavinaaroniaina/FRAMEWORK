...
public class Employee {
    ...
    public ModelView genererEmployer(String nom, int age) {
        String viewUrl = "listeEmployer.jsp";
        ModelView mv = new ModelView(viewUrl);
        mv.add("emp", new Employee(nom, age));
        return mv;
    ...
    @AnnotationMethod("/TEST_FRAMEWORK/login")
    public ModelView login() {
        String viewUrl = "login.jsp";
        ModelView mv = new ModelView(viewUrl);
        return mv;
    }
    @AnnotationMethod("/TEST_FRAMEWORK/connect")
    public ModelView connect(@AnnotationParameter("username") String username, @AnnotationParameter("password") String password, MySession session) {
        String viewUrl;
        if ("Tiavina".equals(username) && "Tiavina123".equals(password)) {
    ...
    @AnnotationMethod("/TEST_FRAMEWORK/logout")
