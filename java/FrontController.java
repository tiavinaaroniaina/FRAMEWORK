        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (paramType == Session.class) {
                ...
                if (parameters[i].isAnnotationPresent(Annotations.AnnotationParameter.class)) {
                    ...
                    throw new IllegalArgumentException("ETU002528 : " + paramName + " is not annoted");
                }
                    ...
                    try {
                        ...
                        for (Field field : fields) {
                            ...
                            if (fieldValue != null) {
                                ...
                                Method m = paramObject.getClass().getDeclaredMethod(setStringer(fieldName), field.getType());
                                if (m != null) {
    ...
    protected void callMethod(Mapping mapping, PrintWriter out, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (mapping.getSession() != null) {
                ...
                field.setAccessible(true);
                Method m = object.getClass().getDeclaredMethod(setStringer(mapping.getSession()), field.getType());
                if (m != null) {
                    m.invoke(object, new Session(request.getSession()));
                }else{
